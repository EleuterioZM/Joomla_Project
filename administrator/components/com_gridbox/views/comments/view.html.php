...
class gridboxViewComments extends JViewLegacy
{
    ...
    protected function addToolBar ()
    {
        ...
        if ($user->authorise('core.edit', 'com_gridbox')) {
            JToolBarHelper::custom('comments.readAll', 'eye.png', 'eye.png', 'MARK_ALL_AS_READ', false);
            JToolBarHelper::custom('comments.unread', 'eye-slash.png', 'eye-slash.png', 'MARK_AS_UNREAD', true);
        }
    }
