...
<span class="input-append input-group">
    <input type="text" class="input-medium form-control" id="jform_request_tag_name" value="<?php echo $title ?>"
        placeholder="<?php echo JText::_('TAG'); ?>" disabled size="35">
<?php
    echo gridboxHelper::renderBootstrapModalBtn('gridbox-category-modal');
?>
</span>
<input type="hidden" id="jform_request_tag_id" name="jform[request][tag]" value="<?php echo $this->value; ?>">
...
<?php
        $url = 'index.php?option=com_gridbox&view=tags&layout=apps&tmpl=component';
