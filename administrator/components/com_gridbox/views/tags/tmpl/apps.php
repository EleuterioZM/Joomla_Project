        ...
        for (var i = 0; i < items.length; i++) {
            items[i].addEventListener('click', function(event){
                ...
                var id = this.dataset.id,
                    url = 'index.php?option=com_gridbox&view=tags&layout=modal&tmpl=component&id='+id,
                ...
                d.querySelector('#jform_request_tag_name').value = '';
                d.querySelector('#jform_request_tag_id').value = '';
                ...
                url = 'index.php?option=com_gridbox&view=blog&layout=tag&app='+id;
