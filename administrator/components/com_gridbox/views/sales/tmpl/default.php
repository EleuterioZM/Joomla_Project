...
<form autocomplete="off" action="<?php echo JRoute::_('index.php?option=com_gridbox&view=sales'); ?>"
                ...
                <div class="ba-main-view">
                    <div id="filter-bar">
                        <div class="app-title-wrapper">
                            <h1><?php echo JText::_('DISCOUNTS'); ?></h1>
                        </div>
...
?>
                    ...
                    <div class="main-table sales-table twin-view-table">
...
?>
                                <tr data-id="<?php echo $item->id; ?>">
                                    ...
                                    <td class="status-td">
                                        <?php echo JHtml::_('gridboxhtml.jgrid.published', $item->published, $i, 'sales.', $canChange); ?>
                                    </td>
                                    <td class="title-cell">
                                        <?php echo $item->title; ?>
                                    </td>
...
?>
                                <span class="disabled apply-sales">
...
?>
                                <span class="disabled duplicate-sales">
...
?>
                                <span class="disabled delete-sales">
                            ...
                            <div class="twin-view-sidebar-body">
                                <div class="sales-options">
                                    <div class="ba-options-group-wrapper">
                                        ...
                                        <div class="ba-options-group-header-wrapper">
                                            <span class="ba-options-group-header"><?php echo JText::_('RESTRICTIONS'); ?></span>
                                        </div>
                                        <div class="ba-options-group-element ba-options-group-applies-wrapper">
                                            ...
                                            <select data-key="applies_to">
                                                ...
                                                <option value="cart"><?php echo JText::_('CART'); ?></option>
                                            </select>
                                        ...
                                        <div class="ba-options-group-element discount-cart-total">
                                            <label class="ba-options-group-label"><?php echo JText::_('DISCOUNT_ON_CART_TOTAL'); ?></label>
                                            <div class="ba-options-price-wrapper">
                                                <span class="ba-options-price-currency">$</span>
                                                <input type="text" class="integer-validation" data-decimals="2" data-key="cart_discount">
                                            </div>
                                        </div>
                                        <div class="ba-options-group-element">
...
?>
                    <div class="ba-create-item ba-add-sales">
                        <a href="#">
...
?>
                    <div>
                        ...
                        <input type="hidden" name="ba_view" value="sales">
