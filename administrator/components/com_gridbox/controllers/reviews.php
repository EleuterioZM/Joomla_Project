...
class gridboxControllerReviews extends JControllerAdmin
{
    public function getModel($name = 'reviews', $prefix = 'gridboxModel', $config = array())
    {
    ...
    public function removeTmpAttachment()
    {
        ...
        gridboxHelper::removeTmpReviewsAttacment($id, $filename);
        exit();
    }
