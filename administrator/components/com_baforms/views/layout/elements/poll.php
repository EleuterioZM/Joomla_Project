...
?>
<div class="ba-form-field-item ba-form-poll-field <?php echo $field->options->suffix ?>" data-type="poll"
...
?>
                    <div class="ba-checkbox-wrapper">
                        ...
                        <label class="ba-form-<?php echo $pollType; ?>">
                            <input type="<?php echo $pollType; ?>"<?php echo $item->default ? ' checked' : ''; ?>>
                            <span></span>
                        </label>
                    </div>
                </div>
