...
?>
<div id="currency-switcher-settings-dialog" class="ba-modal-cp draggable-modal-cp modal hide">
    ...
    <div class="modal-body">
        <div class="general-tabs">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#currency-switcher-general-options" data-toggle="tab">
                        <i class="zmdi zmdi-settings"></i>
                        <span><?php echo JText::_('GENERAL'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="#currency-switcher-design-options" data-toggle="tab">
                        <i class="zmdi zmdi-format-color-fill"></i>
                        <span><?php echo JText::_('DESIGN'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="#currency-switcher-layout-options" data-toggle="tab">
            ...
            <div class="tab-content">
                <div id="currency-switcher-general-options" class="row-fluid tab-pane active">
                    <div class="ba-settings-group">
                        <div class="ba-settings-item">
                            <span>
                                <?php echo JText::_('LAYOUT'); ?>
                            </span>
                            <div class="ba-custom-select currency-switcher-layout-select">
...
?>
                ...
                <div id="currency-switcher-design-options" class="row-fluid tab-pane">
                    <div class="ba-settings-group
                        ...
                        <div class="ba-settings-item">
                            ...
                            <div class="ba-custom-select slideshow-style-custom-select">
                                ...
                                <i class="zmdi zmdi-caret-down"></i>
                                <ul>
                                    <li data-value="switcher"><?php echo JText::_('CURRENCY_SWITCHER'); ?></li>
                                    <li data-value="list"><?php echo JText::_('CURRENCY_LIST'); ?></li>
...
?>
                ...
                <div id="currency-switcher-layout-options" class="row-fluid tab-pane">
<?php
