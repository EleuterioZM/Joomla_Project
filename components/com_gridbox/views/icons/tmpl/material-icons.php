...
<div class='ba-options-group'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-battery-alert '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-battery-unknown '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-collection-item-8 '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-flash-auto '></i>
		<span>flash-auto </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-flash-off '></i>
		<span>flash-off </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-invert-colors-off '></i>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Notifications</p>
	<div class='ba-group-element'>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Person</p>
	<div class='ba-group-element'>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Editor</p>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-border-style '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-format-clear '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-format-color-reset '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-format-ltr '></i>
		<span>format-ltr </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-format-rtl '></i>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Comment</p>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-comment-image '></i>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Hardware</p>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-bluetooth-search '></i>
		<span>bluetooth-search </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-bluetooth-setting '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-camera-front '></i>
		<span>camera-front </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-camera-mic '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-camera-rear '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-card-alert '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-input-hdmi '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-input-svideo '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-mic-setting '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-network-alert '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-network-off '></i>
		<span>network-off </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-network-outline '></i>
		<span>network-outline </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-network-setting '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-phone-locked '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-smartphone-info '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-smartphone-setting '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-videocam-switch '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-wifi-outline '></i>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Directional</p>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-unfold-less '></i>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Map (aliases)</p>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-directions-bike '></i>
		<span>directions-bike </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-directions-boat '></i>
		<span>directions-boat </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		...
		<span>directions-car </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-directions-railway '></i>
		<span>directions-railway </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-directions-run '></i>
		<span>directions-run </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-directions-subway '></i>
		<span>directions-subway </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-directions-walk '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-airport '></i>
		<span>local-airport </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-atm '></i>
		<span>local-atm </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-bar '></i>
		<span>local-bar </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-cafe '></i>
		<span>local-cafe </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-car-wash '></i>
		<span>local-car-wash </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-convenience-store '></i>
		<span>local-convenience-store </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		...
		<span>local-drink </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-florist '></i>
		<span>local-florist </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-gas-station '></i>
		<span>local-gas-station </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		...
		<span>local-hotel </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-laundry-service '></i>
		<span>local-laundry-service </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		...
		<span>local-mall </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-movies '></i>
		<span>local-movies </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-parking '></i>
		<span>local-parking </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-pharmacy '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-pizza '></i>
		<span>local-pizza </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-activity '></i>
		<span>local-activity </span>
	...
	<div class='ba-group-element'>
		...
		<span>local-post-office </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-printshop '></i>
		<span>local-printshop </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-see '></i>
		<span>local-see </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-local-taxi '></i>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>View</p>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-apps '></i>
		<span>apps </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-grid-off '></i>
		<span>grid-off </span>
	</div>
	<div class='ba-group-element'>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Date / Time</p>
	<div class='ba-group-element'>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Social</p>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-google-pages '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-language-python '></i>
		<span>language-python </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-lastfm '></i>
		<span>lastfm </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-steam-square '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-disqus '></i>
		<span>disqus </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-flattr '></i>
		<span>flattr </span>
	</div>
	<div class='ba-group-element'>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Image</p>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-aspect-ratio-alt '></i>
		<span>aspect-ratio-alt </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-aspect-ratio '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-brightness-setting '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-crop-16-9 '></i>
		<span>crop-16-9 </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-crop-3-2 '></i>
		<span>crop-3-2 </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-crop-5-4 '></i>
		<span>crop-5-4 </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-crop-landscape '></i>
		<span>crop-landscape </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-crop-portrait '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-hdr-off '></i>
		<span>hdr-off </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-hdr-strong '></i>
		<span>hdr-strong </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-hdr-weak '></i>
		<span>hdr-weak </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-hdr '></i>
		<span>hdr </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-iridescent '></i>
		<span>iridescent </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-leak-off '></i>
		<span>leak-off </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-panorama-vertical '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-tonality '></i>
		<span>tonality </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-vignette '></i>
		<span>vignette </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-wb-auto '></i>
		<span>wb-auto </span>
	</div>
</div>
<div class='ba-options-group'>
	<p class='ba-group-title'>Audio / Video</p>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-eject-alt '></i>
		<span>eject-alt </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-repeat-one '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-surround-sound '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-volume-mute '></i>
...
<div class='ba-options-group'>
	<p class='ba-group-title'>Numbers</p>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-n-4-square '></i>
		<span>n-4-square </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-n-5-square '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-sec-10 '></i>
		<span>sec-10 </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-sec-3 '></i>
		<span>sec-3 </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-zero '></i>
		<span>zero </span>
	</div>
</div>
<div class='ba-options-group'>
	<p class='ba-group-title'>Other</p>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-airline-seat-flat-angled '></i>
		<span>airline-seat-flat-angled </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-airline-seat-flat '></i>
		<span>airline-seat-flat </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-airline-seat-individual-suite '></i>
		<span>airline-seat-individual-suite </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-airline-seat-legroom-extra '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-flip-to-back '></i>
		<span>flip-to-back </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-flip-to-front '></i>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-hd '></i>
		<span>hd </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-hq '></i>
		<span>hq </span>
	</div>
	<div class='ba-group-element'>
	...
	<div class='ba-group-element'>
		<i class='zmdi zmdi-vibration '></i>
		<span>vibration </span>
	</div>
	<div class='ba-group-element'>
		<i class='zmdi zmdi-voicemail '></i>
		<span>voicemail </span>
	</div>
</div>
