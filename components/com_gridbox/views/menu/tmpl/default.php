...
$ordering = $input->cookie->get('menu_ordering', 'id', 'string');
$direction = $input->cookie->get('menu_direction', 'desc', 'string');
...
<div id="ba-media-manager" class="menu ba-integration-plugin" data-type="menu">
