...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('categories');
?>
<div class="ba-item-categories ba-item" id="item-<?php echo $now; ?>" data-app="">
    <div class="ba-categories-wrapper <?php echo $obj->items->{'item-'.$now}->layout->layout; ?>">
        [ba_blog_categories]
    </div>
