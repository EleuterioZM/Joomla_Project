...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('icon');
?>
<div class="ba-item-icon ba-item" id="item-<?php echo $now; ?>">
	<div class="ba-icon-wrapper">
        <i class="<?php echo $data; ?> ba-btn-transition" data-icon="<?php echo $data; ?>"></i>
    </div>
