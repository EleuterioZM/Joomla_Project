...
$fieldIndex = 'item-'.($now * 1 + 1);
$obj->items->{'item-'.$now}->items->{'0'}->field_key = $fieldIndex;
?>
<div class="ba-item-field-group ba-item" id="<?php echo 'item-'.$now; ?>">
    <div class="ba-field-group-wrapper">
        <div class="ba-field-wrapper ba-label-position-left" data-id="<?php echo $fieldIndex; ?>">
            <div class="ba-field-label"><p>Label</p></div>
            <div class="ba-field-content">Value</div>
        </div>
    </div>
