...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('cart');
...
?>
<div class="ba-item-cart ba-item" id="item-<?php echo $now; ?>">
	<div class="ba-button-wrapper">
        <a class="ba-btn-transition">
            <span class="ba-cart-subtotal <?php echo $currency->position; ?>">
                <span class="store-currency-symbol"><?php echo $currency->symbol; ?></span>
                <span class="store-currency-price"><?php echo $price; ?></span>
            </span>
            <i class="zmdi zmdi-mall" data-products-count="1"></i>
        </a>
    </div>
