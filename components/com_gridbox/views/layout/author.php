...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('author');
?>
<div class="ba-item-author ba-item" id="item-<?php echo $now; ?>">
    <div class="ba-posts-author-wrapper ba-classic-layout">
        [ba_blog_post_author]
    </div>
