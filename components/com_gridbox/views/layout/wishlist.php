...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('wishlist');
?>
<div class="ba-item-wishlist ba-item" id="item-<?php echo $now; ?>">
	<div class="ba-button-wrapper">
        <a class="ba-btn-transition">
            <span class="ba-wishlist-title">
                <?php echo $obj->items->{'item-'.$now}->title; ?>
            </span>
            <i class="<?php echo $obj->items->{'item-'.$now}->icon->icon; ?>" data-products-count="1"></i>
        </a>
    </div>
