...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('currency-switcher');
?>
<div class="ba-item-currency-switcher ba-item" id="item-<?php echo $now; ?>">
    <div class="ba-currency-switcher-wrapper <?php echo $obj->items->{'item-'.$now}->layout; ?>">
        <div class="ba-currency-switcher-active"></div>
        <div class="ba-currency-switcher-list">
            <i class="ba-icons ba-icon-close"></i>
        </div>
        <div class="ba-currency-switcher-backdrop"></div>
    </div>
