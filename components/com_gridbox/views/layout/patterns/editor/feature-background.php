...
$attr = isset($options['group']) ? 'data-group="'.$options['group'].'"': 'data-group="background"';
    ...
    <div class="ba-states-wrapper">
        <div class="ba-states-actions-wrapper">
            <div class="ba-states-icons-wrapper">
                <span class="ba-states-icon" <?php echo $attr; ?> data-action="default"
                    data-method="setFeatureBackgroundValues">
                ...
                <span class="ba-states-icon" <?php echo $attr; ?> data-action="hover"
                    data-method="setFeatureBackgroundValues">
