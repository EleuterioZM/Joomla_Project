...
$unsubscribe = JUri::root().'index.php?task=comments.unsubscribe&key='.$hash;
ob_start();
?>
<table style="
margin:0 auto;
                                ...
                                <table style="width: 100%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            padding-bottom: 25px;
                                            color: #000000;
                                            "><?php echo JText::_('NEW_REPLY_TO_COMMENT_ON'); ?>
                                ...
                                <table style="width: 100%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            line-height: 24px;
                                            text-decoration: none;
                                            "><?php echo JText::_('YOU_RECEIVED_EMAIL_SINCE_POSTED_COMMENT'); ?> 
                                                <a href="<?php echo JUri::root().'index.php/commentID-'.$data->id; ?>" style="
                                                color: #1da6f4;
                                                font-family:Arial,sans-serif;
                                                font-size:12px;
