                                ...
                                <table style="width: 100%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            color: #000000;
                                            ">
                <?php echo $data->parent == 0 ? JText::_('REVIEW_FLAGGED_SPAM_ABUSIVE_ON') : JText::_('COMMENT_FLAGGED_SPAM_ABUSIVE_ON'); ?>
...
<?php
                                            if ($data->parent == 0) {
                                                $totalRating = (string)$data->rating;
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            ">
                                                ...
                                                text-decoration: none;
                                                ">
                                        <?php echo $data->parent == 0 ? JText::_('VIEW_REVIEW') : JText::_('VIEW_COMMENT'); ?>
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
