...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('video');
?>
<div class="ba-item-video ba-item" id="<?php echo 'item-'.$now; ?>">
    <div class="ba-video-wrapper">
        <iframe src="https://www.youtube.com/embed/?start=0&showinfo=1&controls=1&autoplay=0" frameborder="0" allowfullscreen></iframe>
    </div>
