...
?>
<div class="ba-item-field-simple-gallery ba-item" id="<?php echo 'item-'.$now; ?>">
	<div class="instagram-wrapper ba-field-content">
<?php
    for ($i = 0; $i < 6; $i++) {
?>
        <div class="ba-instagram-image"
            style="background-image: url(<?php echo JUri::root(); ?>components/com_gridbox/assets/images/default-theme.png);">
            <img src="<?php echo JUri::root(); ?>components/com_gridbox/assets/images/default-theme.png"
                data-src="components/com_gridbox/assets/images/default-theme.png">
