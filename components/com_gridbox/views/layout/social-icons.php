...
ob_start();
$socialIcons = gridboxHelper::getOptions('social-icons');
$obj->items->{'item-'.$now} = $socialIcons;
?>
<div class="ba-item-social-icons ba-item" id="item-<?php echo $now; ?>">
	<div class="ba-icon-wrapper">
<?php
    foreach ($socialIcons->icons as $key => $value) {
?>
        <a href="<?php echo $value->link->link; ?>" target="<?php echo $value->link->target; ?>">
            <i class="<?php echo $value->icon; ?> ba-btn-transition"></i>
        </a>
<?php
    }
?>
