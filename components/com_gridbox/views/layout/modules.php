...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('modules');
$obj->items->{'item-'.$now}->integration = $data;
?>
<div class="ba-item-modules ba-item" id="<?php echo 'item-'.$now; ?>">
	<div class="integration-wrapper">
        <input type="hidden" class="modules-styles">
        [modules ID=<?php echo $data; ?>]
    </div>
