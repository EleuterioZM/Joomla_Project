...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('related-posts');
?>
<div class="ba-item-related-posts ba-item" id="item-<?php echo $now; ?>" data-app="" data-count="" data-related="" data-maximum="">
