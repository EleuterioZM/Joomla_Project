...
?>
<div class="ba-item-recent-posts-slider ba-item" id="item-<?php echo $now; ?>">
    <div class="slideset-wrapper">
        <ul class="ba-slideset nav-hover carousel-type caption-hover caption-over">
            <div class="slideshow-content">[ba_recent_posts_slider]</div>
