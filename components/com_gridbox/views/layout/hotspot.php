...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('hotspot');
?>
<div class="ba-item-hotspot ba-item" id="<?php echo 'item-'.$now; ?>">
    <div class="ba-button-wrapper">
        <a class="ba-btn-transition" href="#">
            <i class="<?php echo $obj->items->{'item-'.$now}->icon; ?>"></i>
        </a>
    </div>
    <div class="ba-hotspot-popover" data-position="<?php echo $obj->items->{'item-'.$now}->position; ?>">
