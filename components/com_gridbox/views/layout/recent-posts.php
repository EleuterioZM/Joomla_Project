...
ob_start();
$obj->items->{'item-'.$now} = gridboxHelper::getOptions('recent-posts');
?>
<div class="ba-item-recent-posts ba-item" id="item-<?php echo $now; ?>" data-app="" data-count="" data-sorting="" data-maximum="">
