...
ob_start();
$object = gridboxHelper::getOptions('breadcrumbs');
$obj->items->{'item-'.$now} = $object;
?>
<div class="ba-item-breadcrumbs ba-item" id="item-<?php echo $now++; ?>">
    <div class="ba-breadcrumbs-wrapper <?php echo $object->layout; ?>"></div>
