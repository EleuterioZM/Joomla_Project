...
<script>
mediaManager.action = '<?php echo JUri::root(); ?>index.php?option=com_gridbox&task=uploader.executeAction';
...
<div id="ba-media-manager">
    <form  action="<?php echo JRoute::_('index.php?option=com_gridbox&layout=uploader&id=&tmpl=component'); ?>"
        ...
        <div id="create-folder-modal" class="ba-modal-sm modal hide">
            <div class="modal-body">
                <h3 class="ba-modal-title"><?php echo JText::_('CREATE_FOLDER'); ?></h3>
        ...
        <div id="move-to-modal" class="ba-modal-md modal hide">
            <div class="modal-body">
                <div class="ba-modal-header">
                    <h3 class="ba-modal-title"><?php echo JText::_('MOVE_TO'); ?></h3>
        ...
        <div id="rename-modal" class="ba-modal-sm modal hide">
            <div class="modal-body">
                <h3 class="ba-modal-title"><?php echo JText::_('RENAME'); ?></h3>
