...
function AddFont($family, $style = '', $file = '', $filename = '', $uni = false)

{
    ...
    if ($uni) {
        ...
        $unifilename = $this->fontpath.'unifont/'.strtolower($filename);
        ...
        if (file_exists($unifilename.'.mtx.php')) {
            ...
            include_once($unifilename.'.mtx.php');
...
function Image($file, $x=null, $y=null, $w=0, $h=0, $type='', $link='', $a = 'L')
...
protected function _putTTfontwidths(&$font, $maxUni) {
    ...
    if (file_exists($font['unifilename'].'.cw127.php')) {
        ...
        include_once($font['unifilename'].'.cw127.php') ;
